...
# Example
# arr = [5, 3, 1, 2, 4]
# The sorted array is [1, 2, 3, 4, 5]. The middle element and the median is 3.
...
# Explanation 0
# The sorted array is [0, 1, 2, 3, 4, 5, 6]. It's middle element is at arr[3] = 3.
